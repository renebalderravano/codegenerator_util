...
FOREIGN KEY (USER_ID) REFERENCES [DataBaseName].users(ID);
...
INSERT INTO [DataBaseName].USERS(ID, USER_NAME, PASSWORD, ACCOUNT_EXPIRED, ACCOUNT_LOCKED, CREDENTIALS_EXPIRED, ENABLED)
